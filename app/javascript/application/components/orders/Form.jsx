  ...
  fetchCollection(name, params = '') {
    axios.get(`api/${name}?${params}`)
      .then(response => {
        ...
        switch(name) {
          case 'cities':    this.setState({ city_id: response.data[0].id }); break;
          case 'users':     this.setState({ user_id: response.data[0].id }); break;
          case 'addresses': this.setState({ address_id: response.data[0].id }); break;
          case 'products':  this.setState({ product_id: response.data[0].id }); break;
        }
